...
CUDA_VISIBLE_DEVICES=0 python main.py --batch_size 16 --transfer_loss_weight 1 --config DANN/DANN.yaml --data_dir /data/jindwang/covid_folder --src_domain pneumonia --tgt_domain covid | tee DAN_COVID_b16_dann.log &
CUDA_VISIBLE_DEVICES=1 python main.py --batch_size 8 --transfer_loss_weight 1 --config DANN/DANN.yaml --data_dir /data/jindwang/covid_folder --src_domain pneumonia --tgt_domain covid | tee DAN_COVID_b8_dann.log &